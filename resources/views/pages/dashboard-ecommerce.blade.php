         ...
         <div class="col s12 m6 l6 xl3">
            <div class="card gradient-45deg-light-blue-cyan gradient-shadow min-height-100 white-text animate fadeLeft">
               <div class="padding-4">
                  <div class="row">
                     <div class="col s7 m7">
                        <i class="material-icons background-round mt-5">subscriptions</i>
                        <p>Subscription</p>
                     </div>
                     <div class="col s5 m5 right-align">
            ...
            <div class="card gradient-45deg-amber-amber gradient-shadow min-height-100 white-text animate fadeRight">
               <div class="padding-4">
                  <div class="row">
                     ...
                     <div class="col s5 m5 right-align">
                        <h5 class="mb-0 white-text">{{$todayAdvertisements}}</h5>
                        <p class="no-margin">Today</p>
                        <p>{{$advertisements}}</p>
                     </div>
                  </div>
         ...
         <div class="col s12 m6 l6 xl3">
            <div class="card gradient-45deg-red-pink gradient-shadow min-height-100 white-text animate fadeLeft">
               <div class="padding-4">
                  <div class="row">
                     <div class="col s7 m7">
                        <i class="material-icons background-round mt-5">feed</i>
                        <p>Article</p>
                     </div>
                     <div class="col s5 m5 right-align">
                        <h5 class="mb-0 white-text">{{$todayArtical}}</h5>
                        <p class="no-margin">Today</p>
                        <p>{{$artical}}</p>
                     </div>
                  </div>
