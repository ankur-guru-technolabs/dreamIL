    ...
    <div class="col s12 m12 l12">
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form id="accountForm" method="post" enctype="multipart/form-data" action="{{url('')}}/udpate_subscription_plan">
            @csrf
            <input type="hidden" name="plan_id" value="{{$plans->id}}">
            <div class="row">
              <div class="input-field col m6 s12">
                <input id="last_name" name="title" type="text" value="{{$plans->title}}">
            ...
            <div class="row">
              <div class="input-field col s12">
                <textarea id="message5" name="description" class="materialize-textarea">{{$plans->description}}</textarea>
            ...
            <div class="row">
              <div class="input-field col m6 s12">
                <input type="text" name="price" id="dob" value="{{$plans->price}}">
              ...
              <div class="input-field col m6 s12">
                <input type="number" name="ads" id="dob" value="{{$plans->ads}}">
            ...
            <div class="row">
                <div class="col s12 input-field">
                  <select name="status">
                    <option @if($plans->status == 'Active') selected @endif value="Active">Active</option>
                    <option @if($plans->status == 'Deactivate') selected @endif value="Deactivate">Deactivate</option>
                  </select>
                  <label>Status</label>
